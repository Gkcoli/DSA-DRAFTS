...
public class ExcelHandler {
	static String fileDirectory = "C:/Users/Ryujin/Documents/Eclipse Java/Loops/TELEMASTERS/s/src/";
...
public static void writeLeagueSummaryData(String filePath, LinkedList<String> data) throws IOException {
...
public static void readPlayMatchAndWriteToLeagueSummary(String playMatchFile, String leagueSummaryFile) {
    try {
        
        LinkedList<String> playMatchData = readPlayMatchData(playMatchFile);

        writeLeagueSummaryData(leagueSummaryFile, playMatchData);

        System.out.println("Data from PlayMatch has been written to League Summary successfully.");
    } catch (IOException e) {
        e.printStackTrace();
    }
}
...
public static LinkedList<String> readPlayMatchData(String playMatchFile) {
    
    LinkedList<String> playMatchData = new LinkedList<>();
    playMatchData.add("PlayMatch Data 1");
    playMatchData.add("PlayMatch Data 2");
  

    return playMatchData;
}

public static void main(String[] args) {
    String playMatchFile = "MatchSched.xlsx"; // 
    String leagueSummaryFile = "LeagueSummaryData.xlsx"; // 

    readPlayMatchAndWriteToLeagueSummary(playMatchFile, leagueSummaryFile);
}
}
