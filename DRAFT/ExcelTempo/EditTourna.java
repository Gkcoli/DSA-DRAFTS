...
//				window.frame.setVisible(true);
		...
		btnPlayMatch.setBounds(885, 135, 119, 39);
		...
		btnEditTeam.setBounds(531, 137, 119, 39);
		frame.getContentPane().add(btnEditTeam);
		
		JButton btnReplacePlayer = new JButton("SUB PLAYER");
		btnReplacePlayer.setVerticalAlignment(SwingConstants.BOTTOM);
		btnReplacePlayer.setForeground(Color.WHITE);
		btnReplacePlayer.setFont(new Font("Tungsten Bold", Font.PLAIN, 20));
		btnReplacePlayer.setBackground(new Color(189, 57, 68));
		btnReplacePlayer.setBounds(531, 237, 119, 39);
		frame.getContentPane().add(btnReplacePlayer);
