...
public class SignIn extends JFrame {
    ...
    public SignIn() throws Exception {
    	String T1FilePath = fileDirectory + "Team1.xlsx";
        String T2FilePath = fileDirectory + "Team2.xlsx";
        String T3FilePath = fileDirectory + "Team3.xlsx";
        String T4FilePath = fileDirectory + "Team4.xlsx";
        ...
        teamOne.addAll(ExcelHandler.readExcelFile(T1FilePath, 0));
        teamTwo.addAll(ExcelHandler.readExcelFile(T2FilePath, 0));
        teamThree.addAll(ExcelHandler.readExcelFile(T3FilePath, 0));
        teamFour.addAll(ExcelHandler.readExcelFile(T4FilePath, 0));
